...
In this post, I'll create a Visual Studio custom project template for AWS Lambda with dependency injection setup and AWS X-Ray configuration.
...
2. Add Startup.cs class for dependency injection and AWS X-Ray setup.
```cs
...
```
4. Create `appsettings.json` and `appsettings.Development.json` file. Copy the content below in `appsettings.Development.json` file and set copy to output directory to Copy if newer.
...
<img src="/posts/images/CreateNuget.JPG" width="100%">
...
Run below command to install template package
 ...
 <img src="/posts/images/InstallNuget.JPG" width="100%">
...
<img src="/posts/images/RawatPankajTemplate.JPG" width="100%">
...
<img src="/posts/images/ResetTemplate.JPG" width="100%">
