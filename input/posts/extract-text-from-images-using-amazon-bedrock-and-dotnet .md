...
You can find complete source code on [github](https://github.com/aws-samples/serverless-patterns/tree/main/bedrock-lambda-cdk-dotnet) with complete instruction on how to deploy on AWS account via CDK.
